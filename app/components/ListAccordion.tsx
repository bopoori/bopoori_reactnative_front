 ...
 */
export function ListItemAccordion(props: ListItemProps) {
  const {
    defaultOpen,
    ListComponents,
    bottomSeparator,
  ...
  return (
    <>
      <View style={$containerStyles}>
        <TouchableOpacity {...TouchableOpacityProps} style={$touchableStyles} onPress={toggleOpen}>
          <ListItemAction
            side="left"
            size={height}
            icon={leftIcon}
